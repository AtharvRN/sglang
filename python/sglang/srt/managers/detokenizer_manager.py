...
class DetokenizerManager(MultiHttpWorkerDetokenizerMixin):
    ...
    def handle_batch_token_id_out(self, recv_obj: BatchTokenIDOutput):
        ...
        return BatchStrOutput(
            ...
            spec_verify_prep_time_s=recv_obj.spec_verify_prep_time_s,
            spec_predictor_time_s=recv_obj.spec_predictor_time_s,
            spec_confidence_gate_time_s=recv_obj.spec_confidence_gate_time_s,
            spec_confidence_gate_state_time_s=recv_obj.spec_confidence_gate_state_time_s,
            spec_post_verify_bookkeeping_time_s=recv_obj.spec_post_verify_bookkeeping_time_s,
