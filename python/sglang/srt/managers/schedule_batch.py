...
class Req(ReqDllmMixin):
    ...
    def __init__(
        ...
        self.dflash_adaptive_linucb_counts: Dict[int, int] = {}
        self.dflash_adaptive_linucb_rounds: int = 0
        self.dflash_adaptive_linucb_A_inv: Dict[int, Any] = {}
        self.dflash_adaptive_linucb_b: Dict[int, Any] = {}
        self.dflash_adaptive_linucb_last_scores: Optional[Dict[int, float]] = None
        self.dflash_adaptive_thompson_counts: Dict[int, int] = {}
        self.dflash_adaptive_thompson_alpha: Dict[int, float] = {}
        self.dflash_adaptive_thompson_beta: Dict[int, float] = {}
        self.dflash_adaptive_thompson_rounds: int = 0
        self.dflash_adaptive_thompson_reward_norm_max: float = 1.0
        self.dflash_adaptive_thompson_last_scores: Optional[Dict[int, float]] = None
